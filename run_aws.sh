...
python3 kurtosis-aws-runner/kurtosis_aws_runner.py --monitoring-token "$PROMETHEUS_REMOTE_WRITE_TOKEN" --env-dir=./deployments/env --on-demand --branch="$(git branch --show-current)" --instance-type=c6a.8xlarge
