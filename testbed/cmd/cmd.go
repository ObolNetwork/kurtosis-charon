...
func New() *cobra.Command {
	return newRootCmd(
		newRunCmd(newRunCmdFunc),
		newCleanCmd(runCleanCmd),
	)
}
...
func newRootCmd(cmds ...*cobra.Command) *cobra.Command {
	root := &cobra.Command{
		Use:   "testbed",
		Short: "Kurtosis-based testing environment",
		Long:  `Run testnet Ethereum networks and analyze Charon performance against each configuration.`,
